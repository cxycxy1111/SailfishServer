...
@WebServlet(name = "MMemberDetailQuery",urlPatterns = "/mMemberDetailQuery")
public class MmemberDetailQuery extends MemberBaseServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session != null) {
            ...
            String s = mMemberService.queryMemberDetail(s_id,m_id);
